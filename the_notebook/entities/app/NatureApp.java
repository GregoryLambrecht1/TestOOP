...
public class NatureApp {
    public static void main(String[] args) {
        ...
        // making new herbivores + omnivores , adding the diet to them and adding to
        // notebook
        ...
        // List<Animal> otherTypeOfList = new LinkedList<>();

        // Herbivore a1 = new Herbivore("cow",200,160,140);
        // herbivore.setPlantDiet(plantDiet);
        // gregNotebook.addAnimal(herbivore);

        // Herbivore a2 = new Herbivore("goat",70,60,90);
        // a1.setPlantDiet(plantDiet);

        // otherTypeOfList.add(a1);
        // otherTypeOfList.add(a2);
        // gregNotebook.setHerbivores(otherTypeOfList);
